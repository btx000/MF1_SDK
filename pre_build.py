...
env.Append(
    CPPPATH = [
        ...
        join(PROJ_DIR, "src", "blur_detect"),
        join(PROJ_DIR, "src", "camera", "include"),
        join(PROJ_DIR, "src", "camera", "ov2640", "include"),
        # join(PROJ_DIR, "src", "network"),
        # join(PROJ_DIR, "src", "network", "esp8285"),
        # join(PROJ_DIR, "src", "network", "esp8285", "http"),
        # join(PROJ_DIR, "src", "network", "esp8285", "mqtt"),
        # join(PROJ_DIR, "src", "network", "esp8285", "qrcode"),
        # join(PROJ_DIR, "src", "network", "esp8285", "wifi"),
        # join(PROJ_DIR, "src", "network", "esp8285", "wifi", "spi"),
        # join(PROJ_DIR, "src", "network", "esp8285", "wifi", "utility"),
        # join(PROJ_DIR, "src", "network", "w5500"),
        # join(PROJ_DIR, "src", "network", "w5500", "httpc"),
        # join(PROJ_DIR, "src", "network", "w5500", "httpd"),
        # join(PROJ_DIR, "src", "network", "w5500", "httpd", "src"),
        # join(PROJ_DIR, "src", "network", "w5500", "httpd", "web_pages"),
        # join(PROJ_DIR, "src", "network", "w5500", "mqtt"),
        # join(PROJ_DIR, "src", "network", "w5500", "spi"),
        # join(PROJ_DIR, "src", "network", "w5500", "src"),
